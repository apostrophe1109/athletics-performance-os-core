...
async function getMaintenanceCapabilities(env) {
  return {
    ...
    rules: {
      ...
      canonicalDataPreviewPresentationRequired: false,
      canonicalDataInlineApprovalIntentSupported: true,
      canonicalDataInlineApprovalOperations: ["INSERT", "UPDATE", "UPSERT"],
      canonicalDataInlineApprovalRequiresExplicitPreviewWaiverAndApplyVerb: true,
      canonicalDataInlineApprovalExactScopeRequired: true,
